...
$date_ago_twohours = date('Y-m-d\TH:i:s', time()-3600*90);  
...
$custAccountIndex->searchValue = '2';
...
$searchFulfilledOrders->basic->linkedTrackingNumbers->operator = 'notEmpty';
...
$j = 2;
while( count($responseSearchFulfilledOrder->searchResult->recordList->record) == 100 ){
...
if ( count($shippedArray) > 0 ){
	...
	$url = 'http://localhost/importOrder/library/amazon_uk2/MarketplaceWebService/pro/submitConfirmFeed.php?index=1';
